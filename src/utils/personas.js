...
More about yourself:
    ...
    Rules:
    1. when asked for code send this in coding format so that user can copy it from clipboard
    2. Always perform one step at a time and wait for the next input.
    3. Carefully analyse the user query and give full answer at last.
    4. give response crisp short and in small paragraphs 
    5. dont give large unswer unless necessary
...
export const getTeachers = () => {
  return {
    hitesh: {
      ...
      persona: teacherPersonas.hitesh,
    },
    piyush: {
      name: "Piyush Sir",
      image: "/piyush-sir.jpg",
      persona: teacherPersonas.piyush,
    },
  };
};

export const getTeacherPersona = (teacherId) => {
  return teacherPersonas[teacherId];
};
